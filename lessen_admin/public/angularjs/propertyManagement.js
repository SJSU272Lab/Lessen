/**
 * Created by Sandeep on 11/26/16.
 */
...
propertyManagement.controller('propertyManagement', function($scope, $http, $window){
    ...
    $scope.approveProperty = function(hostId){
        ...
        $http({
            ...
            console.log(data);
            $window.location.assign('/admin_pendingProduct');
    ...
    $scope.updateProperty = function(id){
        console.log("update Property gets called: "+id);
        ...
        $http({
            ...
            $window.location.assign('/admin_activeProductManagement');
            //$scope.getProp=data;
        })
    };

    $scope.updateProperty1 = function(id){
        console.log("update Property gets called: "+id);
        var productPrice = $scope.productPrice;
        var saleType= $scope.saleType;
        $http({
